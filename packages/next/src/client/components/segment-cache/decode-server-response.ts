...
export function createRouteTreeNode<TData>(
  ...
  if (Array.isArray(originalSegment)) {
    ...
    if (requestKey.endsWith(PAGE_SEGMENT_KEY)) {
      ...
      // The head is keyed under the first page's request key and varies on the
      // same params as that page (see getHeadRequestKey). Write its vary path
      // into the accumulator object.
