...
const reactWithLedgers = React as unknown as {
  ...
  captureLedgers<T>(
    data: T,
    ledgers: readonly [SetLedger<VaryParamId>]
  ): { data: T; ledgers: [Promise<Set<VaryParamId>>] }
}
...
export const VaryParamsLedger =
  ...
  typeof reactWithLedgers.createSetLedger === 'function'
    ? reactWithLedgers.createSetLedger<VaryParamId>()
    : (null as unknown as SetLedger<VaryParamId>)
